const tokens = {
  ...
  "colors.text.emphasized": {
    "value": "var(--colors-text-emphasized)",
    "variable": "var(--colors-text-emphasized)"
  },
  "colors.text.muted": {
  ...
  "colors.accent.light": {
    "value": "var(--colors-accent-light)",
    "variable": "var(--colors-accent-light)"
  },
